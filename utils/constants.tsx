...
import { FaPaw, FaMedal, FaGamepad, FaRandom } from 'react-icons/fa';
...
export const footerList2 = [ 'wee-bit for Good','Advertise','Developers','Transparency','wee-bit Rewards' ]
